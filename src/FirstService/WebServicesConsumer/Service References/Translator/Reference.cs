...
namespace WebServicesConsumer.Translator {
    ...
    public partial class GetTranslationsResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private WebServicesConsumer.Translator.TranslationMatch[] TranslationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false)]
        public WebServicesConsumer.Translator.TranslationMatch[] Translations {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://api.microsofttranslator.com/V2", ConfigurationName="Translator.LanguageService")]
    public interface LanguageService {
        ...
        WebServicesConsumer.Translator.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, WebServicesConsumer.Translator.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        void AddTranslationArray(string appId, WebServicesConsumer.Translator.Translation[] translations, string from, string to, WebServicesConsumer.Translator.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        WebServicesConsumer.Translator.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, WebServicesConsumer.Translator.TranslateOptions options);
        ...
        WebServicesConsumer.Translator.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, WebServicesConsumer.Translator.TranslateOptions options);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LanguageServiceChannel : WebServicesConsumer.Translator.LanguageService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LanguageServiceClient : System.ServiceModel.ClientBase<WebServicesConsumer.Translator.LanguageService>, WebServicesConsumer.Translator.LanguageService {
        ...
        public WebServicesConsumer.Translator.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, WebServicesConsumer.Translator.TranslateOptions options) {
        ...
        public void AddTranslationArray(string appId, WebServicesConsumer.Translator.Translation[] translations, string from, string to, WebServicesConsumer.Translator.TranslateOptions options) {
            base.Channel.AddTranslationArray(appId, translations, from, to, options);
        }
        
        public WebServicesConsumer.Translator.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, WebServicesConsumer.Translator.TranslateOptions options) {
        ...
        public WebServicesConsumer.Translator.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, WebServicesConsumer.Translator.TranslateOptions options) {
